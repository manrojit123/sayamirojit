(function ($) {
  ...
  if ($(window).width() < 768) {
    ...
    function toggleDropdown(e) {
      const _d = $(e.target).closest(".menu-item-has-children"),
        _m = $(".dropdown-menu", _d);
      setTimeout(
        function () {
  ...
  var msgs = [
    "Solve issues with mobile wireless connectivity ",
    ...
    "More wireless telecom control with CBRS",
  ...
  var msgs2 = [
    "Solve with CBRS",
    "Lower your TCO with CBRS",
    "Flexible Capex and Opex options",
  ];
